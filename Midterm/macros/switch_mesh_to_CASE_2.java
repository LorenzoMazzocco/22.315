// Simcenter STAR-CCM+ macro: switch_mesh_to_CASE_2.java
...
public class switch_mesh_to_CASE_2 extends StarMacro {
  ...
  private void execute0() {
    ...
    directedPatchSourceMesh_0.defineMeshPatchCurve(patchCurve_1, patchCurve_1.getStretchingFunction(), 0.1, 0.1, 32, false, false);
    ...
    directedPatchSourceMesh_0.defineMeshPatchCurve(patchCurve_0, patchCurve_0.getStretchingFunction(), 0.1, 0.1, 52, false, false);
